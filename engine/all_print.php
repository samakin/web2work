...
if( $config['http_home_url'] == "" ) {
	...
	$config['http_home_url'] = explode( "engine/all_print.php", $_SERVER['PHP_SELF'] );
...
if ($_REQUEST['action']=='bank') { include_once ENGINE_DIR . '/modules/content/banki/print/'.$_REQUEST[page].'.php'; } else include_once ENGINE_DIR . '/modules/content/'.$_REQUEST[page].'.php';
