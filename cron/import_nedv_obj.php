...
require_once (ENGINE_DIR.'/inc/imports/functions_nedvpredl.php');
...
require_once (ENGINE_DIR.'/data/import.market.nedv.php');
require_once (ENGINE_DIR.'/data/config.php');

if (($_GET[city]!='' or $confms['city']!='') and ($_GET[cat]!='' or $confms['imp_catin']!=''))
{
...
get_content_obj('');
	...
	$i .='Предложения недвижимости выгружены';
	print_r($i);
}
else
{
